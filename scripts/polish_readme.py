...
ROADMAP = [
    ...
    ("bioinformatics", "21 Multi-omics sample prioritization engine"),
    ("bioinformatics", "22 CRISPR guide risk ranking system"),
    ("bioinformatics", "23 Pathogen genome surveillance dashboard"),
    ("bioinformatics", "24 Protein domain intelligence mapper"),
    ("lab-data-analysis", "25 Digital twin bioreactor optimizer"),
    ("lab-data-analysis", "26 High-throughput screening hit selector"),
    ("medical-coding-healthcare-data", "27 Clinical cohort stratification engine"),
    ("medical-coding-healthcare-data", "28 Pharmacovigilance signal triage system"),
    ("biotech-ai-tools", "29 Explainable biomarker discovery console"),
    ("biotech-ai-tools", "30 Regulatory submission readiness auditor"),
]
